	...
	if(isset($_POST['submit']))
{
   ...
   $first_name=$_POST['first_name'];                           
	...
	$password=$_POST['password'];
     ...
     $query= "UPDATE demo SET    first_name='$first_name',last_name='$last_name',gender='$gender',age='$age',phone='$phone',address='$address',city='$city',state='$state',zip='$zip',about='$about',email='$email',password='$password', imagename='$imagename' WHERE id=$id; ";
	$run=mysqli_query($con,$query);
      ...
      <div class="form-group">
        ...
        <div class="col-md-10  inputGroupContainer">
          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            <input  name="first_name" placeholder="First Name" class="form-control"  value="<?php echo $cheak['first_name']; ?>" type="text">
          </div>
        </div>
      </div>
	   ...
	   <div class="form-group">
        ...
        <div class="col-md-10  inputGroupContainer">
          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
           ...
           <label class="radio-inline"><input type="radio" value="male" name="gender">female</label>
          </div>
        </div>
      </div>
	  </br>
